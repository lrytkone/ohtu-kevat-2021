...
class TestKauppa(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 2:
                return Tuote(2, "Pedro's Negros 40%", 10)
            if tuote_id == 3:
                return Tuote(3, "Kädenlämpönen raanavesi", 3)
    ...
    def test_kahden_saman_tuotteen_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu oikeilla arvoilla
        self.pankki_mock.tilisiirto.assert_called_with("pekka", 42, "12345", ANY, 20)

    def test_kahden_eri_tuotteen_joista_toinen_loppu_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
    ...
    def test_lisataan_koriin_ja_poistetaan_korista_ja_todetaan_etta_oikea_summa_veloitetaan(self):
